...
\[
M_{\text{total}} = m_0 + \sum_i m_i
\]

\[
\mathbf{r}_{\text{CG}} = \frac{ m_0 \langle 0, 0, 0 \rangle + \sum_i m_i \mathbf{r}_i }{M_{\text{total}}}
                   = \frac{ \sum_i m_i \mathbf{r}_i }{M_{\text{total}}}
\]

CG components:

\[
x_{\text{CG}} = \frac{\sum_i m_i x_i}{M_{\text{total}}},\quad
y_{\text{CG}} = \frac{\sum_i m_i y_i}{M_{\text{total}}},\quad
z_{\text{CG}} = \frac{\sum_i m_i z_i}{M_{\text{total}}}
\]
